...
const { nomenclatureIdValidation, nomenclatureBodyValidation, nomenclatureUpdateValidation } = require('../validators/nomenclatureValidator');
...
router.put('/:id', nomenclatureIdValidation, nomenclatureUpdateValidation, nomenclatureController.updateNomenclature);
